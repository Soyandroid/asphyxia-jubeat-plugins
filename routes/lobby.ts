...
const Entry = (req: EamuseInfo, data: any, send: EamuseSend) => {
  const {
    data: { music },
  } = data;
...
const Refresh = (req: EamuseInfo, data: any, send: EamuseSend) => {
  // To Do: Localmatching working
  return send.object(
    {
